...
#Full Adjacency matrix
vars = c("totPrecip", "meanWTE", "totQ",  "S2S_SH", "S2S_DP", "S2N_SH", "S2N_DP", "totSnow")
...
for(i in seq(1, length(vars))){
  for(j in seq(1, length(vars))){
    ...
    for(l in seq(1, lags)){
      #Shift data
      shifted = lagTS(data_monthly_snow[iv], data_monthly_snow[jv], l = l)
...
#[1]"totPrecip", [2]"meanWTE", [3]"totQ",  [4]"S2S_SH", [5]"S2S_DP", [6]"S2N_SH", [7]"S2N_DP", [8]"totSnow", 
