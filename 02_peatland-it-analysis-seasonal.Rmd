...
for(month2 in c('Melt', 'Growing')){
  ...
  save_plot(paste0(fig_save, 'Dormant', month2, 'SlicedTemp_Heatmap.pdf'), subsetSeasons_slicedheatmap_temp, base_height = 3)
  save_plot(paste0(fig_save, 'Dormant', month2, 'SlicedTemp_Heatmap.jpeg'), subsetSeasons_slicedheatmap_temp, base_height = 3)
  ...
  save_plot(paste0(fig_save, 'Dormant', month2, 'SlicedPrecip_Heatmap.pdf'), subsetSeasons_slicedheatmap_precip, base_height = 3)
  save_plot(paste0(fig_save, 'Dormant', month2, 'SlicedPrecip_Heatmap.jpeg'), subsetSeasons_slicedheatmap_precip, base_height = 3)
  ...
  save_plot(paste0(fig_save, 'Dormant', month2, 'SlicedSoil_Heatmap.pdf'), subsetSeasons_slicedheatmap_soil, base_height = 3)
  save_plot(paste0(fig_save, 'Dormant', month2, 'SlicedSoil_Heatmap.jpeg'), subsetSeasons_slicedheatmap_soil, base_height = 3)
...
for(month2 in c('Dormant', 'Growing')){
  ...
  save_plot(paste0(fig_save, 'melt', month2, 'SlicedTemp_Heatmap.pdf'), subsetSeasons_slicedheatmap_temp, base_height = 3)
  save_plot(paste0(fig_save, 'melt', month2, 'SlicedTemp_Heatmap.jpeg'), subsetSeasons_slicedheatmap_temp, base_height = 3)
  ...
  save_plot(paste0(fig_save, 'melt', month2, 'SlicedPrecip_Heatmap.pdf'), subsetSeasons_slicedheatmap_precip, base_height = 3)
  save_plot(paste0(fig_save, 'melt', month2, 'SlicedPrecip_Heatmap.jpeg'), subsetSeasons_slicedheatmap_precip, base_height = 3)
  ...
  save_plot(paste0(fig_save, 'melt', month2, 'SlicedSoil_Heatmap.pdf'), subsetSeasons_slicedheatmap_soil, base_height = 3)
  save_plot(paste0(fig_save, 'melt', month2, 'SlicedSoil_Heatmap.jpeg'), subsetSeasons_slicedheatmap_soil, base_height = 3)
